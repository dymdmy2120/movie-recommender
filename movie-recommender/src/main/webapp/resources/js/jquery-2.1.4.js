...
(function (global, factory) {
   ...
   */
      (function (window) {
        ...
        // Instance-specific data
            expando = "sizzle"
                + 1
                * new Date(), preferredDoc = window.document, dirruns = 0, done = 0, classCache = createCache(), tokenCache = createCache(), compilerCache = createCache(), sortOrder = function (a, b) {
              if (a === b) {
                hasDuplicate = true;
              }
              return 0;
        ...
        // Attribute selectors: http://www.w3.org/TR/selectors/#attribute-selectors
            ...
            pseudos = ":(" + characterEncoding + ")(?:\\((" + // To reduce the number of selectors needing tokenize in
                                                              // the preFilter, prefer
                  // arguments: 1. quoted (capture 3;
        ...
        // preceding the latter
            ...
            matchExpr = {
              ...
              "CHILD": new RegExp("^:(only|first|last|nth|nth-last)-(child|of-type)(?:\\("
                  ...
                  + whitespace
                  + "*\\)|)", "i"),
              "bool": new RegExp("^(?:" + booleans + ")$", "i"), // For use in libraries
                                                                 // implementing .is()
        ...
        function siblingCheck(a, b) {
          var cur = b && a, diff = cur && a.nodeType === 1 && b.nodeType === 1 && ( ~b.sourceIndex
        ...
        setDocument = Sizzle.setDocument = function (node) {
          ...
          Expr.find["TAG"] = support.getElementsByTagName ? function (tag, context) {
            if (typeof context.getElementsByTagName !== "undefined") {
              ...
              function (tag, context) {
                var elem, tmp = [], i = 0, // By happy coincidence, a (broken) gEBTN appears on DocumentFragment
                // nodes too
          ...
          sortOrder = hasCompare ? function (a, b) {
            ...
            if (!aup || !bup) {
              return a === doc ? -1 : b
              === doc ? 1 : aup ? -1 : bup ? 1 : sortInput ? ( indexOf(sortInput, a)
        ...
        Sizzle.matchesSelector = function (elem, expr) {
          ...
          if (support.matchesSelector && documentIsHTML && ( !rbuggyMatches
        ...
        Expr = Sizzle.selectors = {
          ...
          filter: {
            ...
            "CHILD": function (type, what, argument, first, last) {
              var simple = type.slice(0, 3) !== "nth", forward = type.slice(-4)
                  !== "last", ofType = what === "of-type";
              ...
              return first === 1 && last === 0 ?
                ...
                // Shortcut for :nth-*(n)
                  ...
                  function (elem, context, xml) {
                    ...
                    !== forward ? "nextSibling" : "previousSibling", parent = elem.parentNode, name = ofType
          ...
          pseudos: {
            ...
            "empty": function (elem) {
              ...
              // :empty is negated by element (1) or content nodes (text: 3; cdata: 4; model ref:
        ...
        function matcherFromGroupMatchers(elementMatchers, setMatchers) {
          var bySet = setMatchers.length > 0, byElement = elementMatchers.length
              > 0, superMatcher = function (seed, context, xml, results, outermost) {
            var elem, j, matcher, matchedCount = 0, i = "0", unmatched = seed
                    && [], setMatched = [], contextBackup = outermostContext, // We must always
                                                                              // have either
                                                                              // seed elements
                                                                              // or outermost
                                                                              // context
                elems = seed || byElement && Expr.find["TAG"]("*", outermost), // Use integer
                                                                               // dirruns iff this
                                                                               // is the outermost
                                                                               // matcher
        ...
        select = Sizzle.select = function (selector, context, results, seed) {
          var i, tokens, token, type, find, compiled = typeof selector
              === "function"
              && selector, match = !seed && tokenize((selector = compiled.selector || selector));
  ...
  jQuery.filter = function (expr, elems, not) {
    ...
    === 1
    && elem.nodeType
    === 1 ? jQuery.find.matchesSelector(elem, expr) ? [elem] : [] : jQuery.find.matches(expr, jQuery.grep(elems, function (elem) {
  ...
  // Strict HTML recognition (#11290: must start with <)
      ...
      init = jQuery.fn.init = function (selector, context) {
        ...
        if (typeof selector === "string") {
          ...
          return typeof rootjQuery.ready !== "undefined" ? rootjQuery.ready(selector) : // Execute immediately if
                                                                                        // ready is
                                                                                        // not
            // present
              selector(jQuery);
  ...
  var rparentsprev = /^(?:parents|prev(?:Until|All))/, // Methods guaranteed to produce a unique set
  // when starting from a unique set
      guaranteedUnique = {
  ...
  jQuery.ready.promise = function (obj) {
    if (!readyList) {
      ...
      // occurred. We once tried to use readyState "interactive" here, but it caused issues like
      // the one discovered by ChrisS here: http://bugs.jquery.com/ticket/12282#comment:15
  ...
  jQuery.event = {
    ...
    trigger: function (event, data, elem, onlyHandlers) {
      ...
      || document], type = hasOwn.call(event, "type") ? event.type : event, namespaces = hasOwn.call(event, "namespace") ? event.namespace.split(".") : [];
    ...
    dispatch: function (event) {
      ...
      var i, j, ret, matched, handleObj, handlerQueue = [], args = slice.call(arguments), handlers = ( data_priv.get(this, "events")
  ...
  function getAll(context, tag) {
    ...
    === undefined
    || tag
    && jQuery.nodeName(context, tag) ? jQuery.merge([context], ret) : ret;
  }
  ...
  function actualDisplay(name, doc) {
    ...
    // getDefaultComputedStyle might be reliably used only on attached element
        ...
        && ( style = window.getDefaultComputedStyle(elem[0]) ) ?
          ...
          // Use of this method is a temporary fix (more like optimization) until something better
  ...
  var // Swappable if display is none or starts with table except "table", "table-cell", or
  // "table-caption"
  ...
  function augmentWidthOrHeight(elem, name, extra, isBorderBox, styles) {
    var i = extra === ( isBorderBox ? "border" : "content" ) ? // If we already have the right measurement,
          // avoid augmentation
  ...
  function getWidthOrHeight(elem, name, extra) {
    ...
    var valueIsBorderBox = true, val = name
    === "width" ? elem.offsetWidth : elem.offsetHeight, styles = getStyles(elem), isBorderBox = jQuery.css(elem, "boxSizing", false, styles)
        === "border-box";
  ...
  jQuery.each(["height", "width"], function (i, name) {
    jQuery.cssHooks[name] = {
      ...
      set: function (elem, value, extra) {
        ...
        return setPositiveNumber(elem, value, extra ? augmentWidthOrHeight(elem, name, extra, jQuery.css(elem, "boxSizing", false, styles)
            === "border-box", styles) : 0);
      }
    };
  });
    ...
    for (prop in props) {
      ...
      if (rfxtypes.exec(value)) {
        ...
        if (value === ( hidden ? "hide" : "show" )) {
          ...
          // If there is dataShow left over from a stopped hide or show and we are going to proceed
  ...
  function Animation(elem, properties, options) {
    var result, stopped, index = 0, length = animationPrefilters.length, deferred = jQuery.Deferred().always(function () {
      ...
      var currentTime = fxNow || createFxNow(), remaining = Math.max(0, animation.startTime
              + animation.duration
              - currentTime), // Support: Android 2.3
  ...
  jQuery.speed = function (speed, easing, fn) {
    ...
    === "number" ? opt.duration : opt.duration
  ...
  jQuery.fn.extend({
    fadeTo: function (speed, to, easing, callback) {
      ...
      return this.each(function () {
        var dequeue = true, index = type
            != null
            && type
            + "queueHooks", timers = jQuery.timers, data = data_priv.get(this);
  ...
  jQuery.fn.extend({
    addClass: function (value) {
      var classes, elem, cur, clazz, j, finalValue, proceed = typeof value
          === "string"
    ...
    removeClass: function (value) {
      var classes, elem, cur, clazz, j, finalValue, proceed = arguments.length
          === 0
          || typeof value
          === "string"
          && value, i = 0, len = this.length;
      ...
      option: {
        ...
        get: function (elem) {
          var value, option, options = elem.options, index = elem.selectedIndex, one = elem.type
              === "select-one"
              || index
              < 0, values = one ? null : [], max = one ? index + 1 : options.length, i = index
          < 0 ? max : one ? index : 0;
          ...
          for (; i < max; i++) {
            ...
            if (( option.selected || i === index ) && // Don't return options that are disabled or in a disabled
                                                      // optgroup
  ...
  function ajaxConvert(s, response, jqXHR, isSuccess) {
    var conv2, current, conv, tmp, prev, converters = {}, // Work with a copy of dataTypes in case we
    // need to modify it for conversion
  ...
  jQuery.extend({
    ...
    ajax: function (url, options) {
      ...
      var transport, // URL without anti-cache param
          ...
          callbackContext = s.context || s, // Context for global events is callbackContext if it
  ...
  jQuery.ajaxPrefilter("json jsonp", function (s, originalSettings, jqXHR) {
    ...
    var callbackName, overwritten, responseContainer, jsonProp = s.jsonp
        !== false
    ...
    jQuery.each({
      ...
      jQuery.fn[funcName] = function (margin, value) {
        var chainable = arguments.length && ( defaultExtra
            || typeof margin
            !== "boolean" ), extra = defaultExtra || ( margin
            === true
            || value
            === true ? "margin" : "border" );
